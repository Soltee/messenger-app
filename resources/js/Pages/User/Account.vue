<template>
    ...
    <BreezeAuthenticatedLayout>
        <template #tab>
            <div class="w-40 h-full  py-6">
   
                <div class="h-full flex flex-col bg-white shadow-xl w-full">
                    <li 
                        @click="select = 'account'; message='';"
                        class="mr-3  w-auto px-4 py-2 group text-lg font-semibold flex text-gray-400 border-r-2 border-gray-300 mb-3 hover:border-gray-900 cursor-pointer w-full"
                        :class="isAccount">
